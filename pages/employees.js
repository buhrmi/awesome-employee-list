...
class EmployeePage extends React.Component {
  ...
  render() {
    ...
    if (this.props.id == 'new') {
      h4 = <h4>New Employee</h4>
    }
    else {
      deleteButton = <button onClick={this.deleteEmployee} className='btn btn-primary btn-danger'>Delete</button>
      h4 = <h4>Edit { this.state.name }</h4>
    }
    return (
      <Layout title={ 'Employeee' }>
        <div className='container'>
          ...
          <form onSubmit={this.saveChanges}>
            ...
            <div className='form-group row'>
              <label htmlFor="job" className="col-sm-2 col-form-label">Job</label>
              <div className="col-sm-10">
